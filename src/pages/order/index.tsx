    ...
    <>
      <div className="flex flex-col h-screen bg-[#F5F5F5]">
        <header className="flex items-center h-16 border-b bg-white dark:bg-gray-800">
          <div className="flex w-2/4 h-full justify-around items-center">
            <Link
        ...
        <div className="w-full flex items-center px-16 h-16 bg-white dark:bg-gray-800 p-2">
          <Combobox />
        </div>

        <div className="flex h-fit py-4 gap-x-4 overflow-x-scroll">
          {stores.map((store) => (
            <Button
              onClick={() => {
        ...
        <div className="h-1/2 flex bg-white border-t-2">
          <div className="w-48 border-r-2 h-full px-2 flex flex-col items-center gap-y-2">
            <Input
              className="pl-8"
              placeholder="Search dishes..."
              type="search"
            ...
            {stores
              .find((store) => store.value === query.store)
              ?.dishTypes.map((item) => (
                <Button
                  onClick={() => {
          ...
          <div className=" ">
            ...
            {stores.find(store => store.value == query.store)?.items.filter(item => item.value === )}
          </div>
        </div>
      </div>
    </>
